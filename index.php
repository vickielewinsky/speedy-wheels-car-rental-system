...
if (!function_exists('base_url')) {
    function base_url($path = '') {
        ...
        if (strpos($script_name, 'speedy-wheels-car-rental-system') !== false || 
            strpos($request_uri, 'speedy-wheels-car-rental-system') !== false) {
            // Apache/XAMPP
            $base = $protocol . '://' . $host . '/speedy-wheels-car-rental-system/';
        } else {
            // PHP built-in server
            $base = $protocol . '://' . $host . '/';
        }
...
// ADDED: This line was in your original but missing in some versions
        ...
        <?php if ($is_admin): ?>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu admin-dropdown-menu">
              ...
              <li><a class="dropdown-item" href="<?= base_url('src/modules/chauffeur/index.php') ?>">
                <i class="fas fa-user-tie text-brown me-2"></i>Manage Chauffeur
              </a></li>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <div class="hero-buttons">
          ...
          <a href="<?= base_url('src/modules/bookings/create_booking.php') ?>" class="btn btn-primary btn-lg px-4 me-3">
            <i class="fas fa-calendar-check me-2"></i>Book Now
          </a>
          <a href="<?= base_url('chauffeur.php') ?>" class="btn btn-gradient-chauffeur btn-lg px-4">
            <i class="fas fa-user-tie me-2"></i>Hire Chauffeur
          </a>
        </div>
      </div>
    </div>
